...
export function mountChrome({ active = '', immersive = false } = {}) {
  ...
  nav.innerHTML = `
    ...
    <div class="nav__links">
      ...
      <a class="nav__cta" href="/download"${active === 'Download' ? ' aria-current="page"' : ''}>Download</a>
    </div>`;
  ...
  footer.innerHTML = `
    <div class="footer__inner">
      ...
      <div class="footer__col">
        ...
        <a href="/network">The Canvas (3D)</a>
      </div>
      <div class="footer__col">
        <h4>Company</h4>
